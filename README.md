...
#### 20 April 2021
 - problems solved with rendering of plots in shiny by downgrading `wordcloud2` package from 0.2.1 to 0.2.0. Please see [here](https://github.com/rstudio/shinydashboard/issues/281) for more details
 - speed increased by saving csvs as Rdata
